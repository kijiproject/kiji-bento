...
public class TestUpgradeCheckin {
  ...
  private String getExpectedJSON() throws IOException {
    return String.format(JSON_FORMAT, EXPECTED_TYPE, EXPECTED_FORMAT, EXPECTED_OS,
        VersionInfo.getSoftwareVersion(), EXPECTED_JAVA_VERSION, EXPECTED_TS, EXPECTED_ID);
  }

  @Test
  public void testBuild() throws IOException {
    LOG.info("Building a check-in message and verifying its fields.");
    UpgradeCheckin checkin = new UpgradeCheckin.Builder()
        .withId(EXPECTED_ID)
    ...
    assertEquals("Bad bento version.", VersionInfo.getSoftwareVersion(), checkin.getBentoVersion());
